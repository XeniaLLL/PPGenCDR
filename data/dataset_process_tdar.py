...
def index_encoding(interaction):
    ...
    for [user_id, item_id, review_text] in interaction:
        ...
        user_text[user_id2num[user_id]] = user_text[user_id2num[user_id]] | review_text #note  review_text is set of string
...
if __name__ == '__main__':
    ...
    dataset = ['movie', 'music', 'book'][dataset_index]
    dataset_name = {'movie': 'Movies_and_TV_5',
                    'video': 'Amazon_Instant_Video_5',
                    'music': 'CDs_and_Vinyl_5',
                    'book': 'Books_5',
                    'clothes': 'Clothing_Shoes_and_Jewelry_5'}[dataset]
    path_read = '../datasets/amazon_review_core_5/'+dataset_name+'.json'
